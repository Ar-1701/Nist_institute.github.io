...
<BR>
    <div class=" container subject bg-info img-rounded">
	<h1 class="subName">O LEVEL</h1>   
        ...
        font-size: large;list-style-position: inside;list-style: none;margin-left: 35px; color: rgb(224, 67, 9)">
         ...
         This six semester long undergraduate program creates skilled, adaptable graduates who are able to design computer-based solutions to address the need of various industry, commerce, science, entertainment and the public sector.
        In this program students are exposed to foundations of computers & IT as well various languages for computer applications development including the latest developments in the industry so that students develop themselves as an application software developer for Desktop, Network based, Web based or mobile applications.</p>      
